...
export enum API_PATHS {
  ...
  GET_ALL_CREATED_PROJECTS_BY_ADDRESS = '/retrieve/createdCollections',
  GET_CONTRACT_BY_NAME = '/getContractDetails',
  WHITELIST = '/whitelist',
  COLLECTION = '/collections',
  CLAIM_FETCH = '/claims/fetch',
  CLAIM_COVER = '/retrieve/cover',
  CLAIM_AUDIO = '/retrieve/originals',
  CLAIM_AUDIOSAMPLES = '/retrieve/originals',
  ...
  CREATE_PROJECT = '/claims/updateAddressForCreatedProject',
  ...
  RETRIEVE_CURATED_COLLECTIONS = '/retrieve/curatedCollectionsClaims',
  RETRIEVE_ART_COLLECTIONS_BASIC = 'retrieve/imageCollectionsBasicInfo',
  RETRIEVE_MUSIC_COLLECTIONS_BASIC = 'retrieve/musicCollectionsBasicInfo'
}

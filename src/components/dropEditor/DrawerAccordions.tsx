      ...
      <AccordionDetails>
        <div>
          <TextField
            ...
            label="Artist"
            variant="outlined"
            onChange={(event) => changeFormState('artist', event.target.value)}
      ...
      <AccordionDetails>
        <Stack>
          <TextField
            ...
            label="Twitter"
            type="text"
            onChange={(event) => changeFormState('twitter', event.target.value)}
          ...
          <TextField
            ...
            label="Discord"
            type="text"
            onChange={(event) => changeFormState('discord', event.target.value)}
